local Translations = {
    error = {
        ...
        'Ocorreu um erro de banco de dados ao conectar-se ao servidor. (O servidor SQL está ativado?)',
    ...
    command = {
        ...
        dvall = { help = 'Excluir todos os veículos (somente administrador)' },
        dvp = { help = 'Excluir todos os Peds (somente administrador)' },
        dvo = { help = 'Excluir todos os objetos (somente administrador)' },
        givemoney = {
