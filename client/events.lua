...
RegisterNetEvent('QBCore:Client:UseItem', function(item)
    ...
    '%s triggered QBCore:Client:UseItem by ID %s with the following data. This event is deprecated due to exploitation, and will be removed soon. Check qs-inventory for the right use on this event.',
